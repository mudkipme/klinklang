      ...
      <Grid container>
        <AppBar position="static" className={classes.root}>
          <Toolbar>
            ...
            <Typography variant="h6" color="inherit" className={classes.title}>52Poké Wiki Utilities</Typography>
            <IconButton component="a" color="inherit" href="https://github.com/mudkipme/klinklang">
              <SvgIcon>
